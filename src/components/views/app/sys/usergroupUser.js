...
import UsergourpUserAdd from "./usergroupUserAdd"

class UsergroupUser extends Component {
    state = {
        ugId: null,
        selectedRowKeys: [],
        loading: false,
            ...
            render: (text, record) => (
                <span>
                    {isAuth('sys:usergroup:delete') &&(
                        <Button size={"small"} type="danger" onClick={()=>this.deleteUsergroupUser(record.userId)}>删除</Button>
                    )}
                </span>
            )
        }]
        ...
        return (
            <div className="gutter-example">
                                ...
                                <div style={{ marginBottom: 16 }}>
                                    ...
                                    {isAuth('sys:usergroup:delete') &&(
                                        <Button type="danger"
                                                ...
                                                onClick={()=>this.deleteUsergroupUser()}
                                        >
                                            批量删除
                                        </Button>
                                    )}
                ...
                <UsergourpUserAdd
                    ...
                    ugId={this.props.match.params.ugId}
                    saveUsergroupUserSuccess={this.saveUsergroupUserSuccess}
                />
